...
public class SaralSwadhanp {
	...
	public String CalculatePrem(String age,String gender,String policyTerm,String premFreq,String sumAssured,String State)
	{
		String retVal="";
		if(policyTerm.equals("10") || policyTerm.equals("15") ) {
		
		try   
		{
			
			
		SaralSwadhanpBean Bean=new SaralSwadhanpBean();	
...
//		saralSwadhanPlusBean.setPlanType(plan);
		Bean.setPremiumFrequency(premFreq); 
		...
		Bean.setPremiumAmount(Integer.parseInt(sumAssured));
		//        System.out.println("* 1.3 *"+Integer.parseInt(basicSA.getText().toString()));


		//Show Output Form
		retVal = showSaralSwadhanOutputPg(Bean);
	...
	public String showSaralSwadhanOutputPg(SaralSwadhanpBean SaralSwadhanPBean)
	{
		...
		String[] outputArr=getOutput("BI_of_Saral_Swadhan_Plus",SaralSwadhanPBean);
...
//		 startActivity(i);
	...
	public String[] getOutput(String sheetName,SaralSwadhanpBean saralSwadhanPlusBean)
	{
		...
		int age = saralSwadhanPlusBean.getAge();
		int policyTerm = saralSwadhanPlusBean.getPolicyTerm();
		double premium =saralSwadhanPlusBean.getPremiumAmount();
		double sumAssured = 0, _annualPrem = 0, benefitPaybleAtDeath = 0, benefitPaybleAtMaturity = 0, SAMF = 0;

		SaralSwadhanBusinessLogic BIMAST = new SaralSwadhanBusinessLogic();
		...
		boolean state =saralSwadhanPlusBean.isState();
		...
		double KeralaCessServiceTaxSecondYear ;
