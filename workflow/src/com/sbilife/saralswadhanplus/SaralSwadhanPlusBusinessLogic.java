...
public class SaralSwadhanPlusBusinessLogic {

	
	  public CommonForAllProd comm=null;
	    public SaralSwadhanPlusProperties ssp_prop=null;
	    public SaralSwadhanPlusBean saralSwadhanPlusBean =null;
	    public SaralSwadhanPlusDB saralSwadhanPlusDB =null;
	   ...
	   public SaralSwadhanPlusBusinessLogic()
	    {
	     ...
	     public double setBenefitPaybleAtDeath(double sumAssured,int year_F,int policyTerm)
	     {
	    	 if(year_F<=policyTerm)
	    		 return sumAssured;
	    	 else
	     ...
	     public double setbenefitPaybleAtMaturity(double premium,int year_F,int policyTerm)
	     {
	    	 if(policyTerm==10 && year_F==ssp_prop.premiumPayingTerm)
	    		 return Double.parseDouble(comm.getRoundUp(comm.getStringWithout_E( ((premium*10)*1))));
	    	 else if(policyTerm==15 && year_F==policyTerm)
	    		 return Double.parseDouble(comm.getRoundUp(comm.getStringWithout_E(((premium*10)*1.15))));
	    	 else
	    		 return 0;
	     }
...
//	 			System.out.println("nnn "+ (premiumWithoutST*prop.serviceTax));
	 				return Double.parseDouble(comm.getRoundOffLevel2(comm.getRoundOffLevel2(comm.getStringWithout_E(premiumWithoutST*ssp_prop.serviceTax))));
	 		}
	 		else if (type.equals("SBC"))
	 		{
	 				return Double.parseDouble(comm.getRoundOffLevel2(comm.getStringWithout_E(premiumWithoutST*ssp_prop.SBCServiceTax)));
	 		}
	 	//  Added By Saurabh Jain on 15/05/2019 Start
	 		else if (type.equals("KERALA"))
	 		{
	 			
	 				return Double.parseDouble(comm.getRoundOffLevel2(comm.getStringWithout_E(premiumWithoutST*ssp_prop.kerlaServiceTax)));

	 		}
	 	//  Added By Saurabh Jain on 15/05/2019 End
	 		else //KKC
	 		{
	 				return Double.parseDouble(comm.getRoundOffLevel2(comm.getStringWithout_E(premiumWithoutST*ssp_prop.KKCServiceTax)));
	 		}
	 	 ...
	 	 public double getServiceTaxSecondYear(double premiumWithoutST,String type)
	 		{
	 			if(type.equals("basic"))
	 			{
	 					return Double.parseDouble(comm.getRoundOffLevel2New(comm.getStringWithout_E(premiumWithoutST*ssp_prop.serviceTaxSecondYear)));
	 			}
	 			else if (type.equals("SBC"))
	 			{
	 					return Double.parseDouble(comm.getRoundOffLevel2New(comm.getStringWithout_E(premiumWithoutST*ssp_prop.SBCServiceTaxSecondYear)));
	 			}
	 		//  Added By Saurabh Jain on 15/05/2019 Start
	 			else if (type.equals("KERALA"))
	 			{
	 					return Double.parseDouble(comm.getRoundOffLevel2New(comm.getStringWithout_E(premiumWithoutST*ssp_prop.kerlaServiceTaxSecondYear)));
	 		...
	 		//  Added By Saurabh Jain on 
	 			...
	 			{
	 					return Double.parseDouble(comm.getRoundOffLevel2New(comm.getStringWithout_E(premiumWithoutST*ssp_prop.KKCServiceTaxSecondYear)));
	 			}
