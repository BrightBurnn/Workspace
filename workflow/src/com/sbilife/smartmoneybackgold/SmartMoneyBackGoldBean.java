...
public class SmartMoneyBackGoldBean {

	//Bean Variable Declaration
    private int ppt=0,age=0,policyTerm=0,policyTerm_PT=0,policyTerm_ADB=0,policyTerm_ATPDB=0,policyTerm_CC13NonLinked=0,sumAssured_Basic=0,sumAssured_ADB=0,sumAssured_ATPDB=0,sumAssured_PT=0,sumAssured_CC13NonLinked=0;
	String premPayOption;
    private String premiumFreq=null,planName=null,gender=null;
    private boolean staffDisc=false,jkResident=false,ADB_Status=false,ATPDB_Status=false,PT_Status=false,CC13NonLinked_Status=false,state=false;
